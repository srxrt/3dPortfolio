			...
			>
              ...
              items-center cursor-pointer"
						...
						<div
							...
							className="black-gradient w-10 h-10 rounded-full flex justify-center
              items-center cursor-pointer ml-1"
						>
							<img
								src={globe}
								alt="url"
		...
		<>
			...
			<div className="w-full flex">
				...
				>
					...
					through real-worl examples of my work. Each project is
					briefly described with links to code repositories and live
					demos in it. It reflects my ability to solve comples
					problems, workwith different technologies, and manage
